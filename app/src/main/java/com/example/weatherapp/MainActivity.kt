...
class MainActivity : AppCompatActivity() {
    ...
    val kota: String = "Bogor,ind"
    val api: String = "563c04d425b4652f1f1fa24231fb6613"
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>()
    {
        override fun onPreExecute() {
            ...
            findViewById<TextView>(R.id.errortexs).visibility = View.GONE
        }

        override fun doInBackground(vararg p0: String?): String? {
            var response: String?
            try {
                response = URL("https://api.openweathermap.org/data/2.5/weather?q=$kota&units=metric&appid=$api")
        ...
        override fun onPostExecute(result: String?) {
            ...
            {
                findViewById<ProgressBar>(R.id.loader).visibility = View.GONE
                findViewById<TextView>(R.id.errortexs).visibility = View.VISIBLE
            }
        }
    }
}